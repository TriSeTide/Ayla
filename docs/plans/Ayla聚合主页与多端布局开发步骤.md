...
- [x] 前端：F1 AppShell + 路由重构已落地；F2 窄屏主页 + 宽屏 /home 重定向已落地；F3 GroupPage 容器 + 群内聊天已落地；F4 直播一级 tab + 群内直播已落地；F5 语音一级 tab + 群内语音已落地；F6 帖子全套已落地；F7 桌游房间框架已落地；F8 消息中心 + badges 红点已落地；F9 全局搜索已落地（2026-08-14）；F10 待执行
- [ ] 两形态主链路 E2E 通过（本文件 §4）
