...
// Local fork (2026-09-17): MSVC has no GCC __sync_synchronize; use _ReadWriteBarrier.
#if defined(_MSC_VER) && !defined(__sync_synchronize)
static inline void __sync_synchronize(void) { _ReadWriteBarrier(); }
#endif
